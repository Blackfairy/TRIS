            ...
            <div class="col-lg-8" style="padding: 35px;">
                <div class="content-box">
                    <div class="basic-group">
                        <form action="<?php echo site_url('home/manuscript_action/create'); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div class="checkbox check-success">
                                <input id="isTopManuscriptCheckbox" type="checkbox" value="1" name = "is_top_manuscript" onclick="topManuscriptChecked(this)">
                    ...
                    <div class="basic-group">
                        ...
                        <div class="row-fluid">
                            <div class="checkbox check-success">
                                <input id="freeManuscriptCheckbox" type="checkbox" value="1" name = "is_free_manuscript" onclick="isFreeManuscriptChecked()">
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input type="text" name = "manuscript_overview_url" id = "manuscript_overview_url" class="form-control">
                            </div>
                        </div>
                    ...
                    <div class="content-update-box">
                        <button type="submit" name = "create_manuscript" class="btn col-4"><?php echo get_phrase('create_manuscript'); ?></button>
...
//     var input_ids = ['title', 'short_description', 'description', 'category_id', 'sub_category_id', 'price', 'manuscript_overview_url'];
