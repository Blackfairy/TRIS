...
<head>
	...
	<?php if ($page_name == 'manuscript_page'):
		$title = $this->crud_model->get_manuscript_by_id($manuscript_id)->row_array()?>
	...
	<?php
	$seo_pages = array('manuscript_page');
	if (in_array($page_name, $seo_pages)):
	$manuscript_details = $this->crud_model->get_manuscript_by_id($manuscript_id)->row_array();?>
		<meta name="keywords" content="<?php echo $manuscript_details['meta_keywords']; ?>"/>
		<meta name="description" content="<?php echo $manuscript_details['meta_description']; ?>" />
	<?php else: ?>
