...
<div class="col-lg-5" style="padding: 35px 0px;" id = "add_form_area">
    <div class="content-box" id = "lesson_adding_form_area">
        <form role="form" class="form-horizontal form-groups-bordered" action="<?php echo site_url('home/manage_lessons/add/'.$manuscript_id); ?>" method="post" enctype="multipart/form-data">
...
<script type="text/javascript">
    ...
    function makeUpdateFormVisible(lesson_id, title, videoURL, duration) {
        var action = '<?php echo site_url('home/manage_lessons/edit/'.$manuscript_id.'/'); ?>' + lesson_id;
