<?php
    ...
    $lessons = $this->crud_model->get_lessons('manuscript', $manuscript_id);
        ...
        <div class="row">
          <div class="col-lg-5" style="padding: 35px 0px;" id = "add_form_area">
              <div class="content-box" id = "lesson_adding_form_area">
                  <form role="form" class="form-horizontal form-groups-bordered" action="<?php echo site_url('home/manage_lessons/edit/'.$manuscript_id.'/'.$lesson_id); ?>" method="post" enctype="multipart/form-data">
                      ...
                      <input type="hidden" name="manuscript_id" value="<?php echo $manuscript_id; ?>">
                      <div class="form-group">
                      ...
                      <div class="form-group">
                          <div class="col-sm-offset-3 col-sm-12">
                              ...
                              <a href="<?php echo site_url('home/edit_manuscript/'.$manuscript_id.'/manage_lesson') ?>" class = "btn btn-success" name="button" style="color: white;"><?php echo get_phrase('cancel'); ?></a>
                          </div>
                      </div>
                  </form>
              </div>
                      ...
                      <tbody>
                          <?php foreach ($lessons->result_array() as $lesson):?>
                              <tr>
                                  ...
                                  <td>
                                      <a href="<?php echo site_url('home/lesson_editing_form/'.$lesson['id'].'/'.$manuscript_id); ?>">
                                          <?php echo get_phrase('edit');?>
                                      </a>
                                      <a href="#" onclick="confirm_modal('<?php echo site_url('home/manage_lessons/delete/'.$manuscript_id.'/'.$lesson['id']); ?>');">
