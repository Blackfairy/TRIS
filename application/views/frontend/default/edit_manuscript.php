<div class="col-lg-8" style="padding: 35px;">
    <div class="content-box">
        <div class="basic-group">
            <form action="<?php echo site_url('home/manuscript_action/edit/'.$manuscript_id); ?>" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="title"><?php echo get_phrase('basics'); ?>:</label>
                        <input type="text" class="form-control" name = "title" id="title" placeholder="<?php echo get_phrase('title'); ?>" required value="<?php echo $manuscript_details['title']; ?>">
                    </div>

                    <div class="form-group">
                        <label for="short_description"><?php echo get_phrase('short_description'); ?>:</label>
                        <textarea class="form-control" name = "short_description" id="short_description" required rows="6"><?php echo $manuscript_details['short_description']; ?></textarea>
                    </div>

                    <div class="form-group">
                        <label for="description"><?php echo get_phrase('description'); ?>:</label>
                        <textarea class="form-control" name = "description" id="description" required rows="6"><?php echo $manuscript_details['description']; ?></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <select class="form-control" id="category_id" name="category_id" onchange="ajax_get_sub_category(this.value)" required>
                                ...
                                <option value="<?php echo $category['id']; ?>" <?php if($manuscript_details['category_id'] == $category['id']) echo 'selected'; ?>><?php echo $category['name']; ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="controls">
                        <select class="form-control" id="sub_category_id" name="sub_category_id" required>
                            <?php
                                $sub_categories = $this->crud_model->get_sub_categories($manuscript_details['category_id']);
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="level">
                        <option value="beginner" <?php if($manuscript_details['level'] == "beginner") echo 'selected'; ?>><?php echo get_phrase('beginner'); ?></option>
                        <option value="advanced" <?php if($manuscript_details['level'] == "advanced") echo 'selected'; ?>><?php echo get_phrase('advanced'); ?></option>
                        <option value="intermediate" <?php if($manuscript_details['level'] == "intermediate") echo 'selected'; ?>><?php echo get_phrase('intermediate'); ?></option>
                    </select>
                </div>
                    ...
                    <select class="form-control" id="language_made_in" name="language_made_in" required>
                        <?php
                            ...
                            <option value="<?php echo $field;?>"
                                <?php if ($manuscript_details['language'] == $field)echo 'selected';?>> <?php echo ucfirst($field);?>
                            </option>
                        <?php endforeach; ?>
                    </select>
                </div>
                ...
                <div class="form-group">
                    <div class="checkbox check-success">
                        <input id="isTopManuscriptCheckbox" type="checkbox" value="1" name = "is_top_manuscript" onclick="topManuscriptChecked(this)" <?php if($manuscript_details['is_top_manuscript'] == 1) echo 'checked'; ?>>
                        <label for="isTopManuscriptCheckbox" onclick="topManuscriptChecked(this)"><?php echo get_phrase('is_top_manuscript'); ?></label>
                    </div>
                </div>
            ...
            <div class="basic-group">
                <div class="row-fluid">
                    <div class="checkbox check-success">
                        <input id="freeManuscriptCheckbox" type="checkbox" value="1" name = "is_free_manuscript" onclick="isFreeManuscriptChecked()" <?php if($manuscript_details['is_free_manuscript'] == 1) echo 'checked'; ?>>
                        <label for="freeManuscriptCheckbox" onclick="isFreeManuscriptChecked()"><?php echo get_phrase('free_manuscript'); ?></label>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="controls">
                        <input type="number" id = "price" name = "price" class="form-control" required value="<?php echo $manuscript_details['price']; ?>" onkeyup="calculateDiscountPercentage($('#discounted_price').val())" min="0">
                    </div>
                </div>

                <div class="row-fluid">
                    <div class="checkbox check-success">
                        <input id="discountCheckbox" type="checkbox" value="1" name = "discount_flag" <?php if($manuscript_details['discount_flag'] == 1) echo 'checked'; ?>>
                ...
                <div class="form-group">
                    ...
                    <div class="controls">
                        <input type="number" name = "discounted_price" id = "discounted_price" class="form-control" onkeyup="calculateDiscountPercentage(this.value)" value="<?php echo $manuscript_details['discounted_price']; ?>" min="0">
                    </div>
                ...
                <div class="content-box">
                    <div class="email-group">
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control" name="manuscript_thumbnail" accept="image/*">
                ...
                <div class="form-group">
                    <label for="description"><?php echo get_phrase('manuscript_overview_provider'); ?>:</label>
                    <select class="form-control" name="manuscript_overview_provider">
                        ...
                        <option value="html5" <?php if($manuscript_details['manuscript_overview_provider'] == 'html5') echo 'selected'; ?>><?php echo get_phrase('HTML5'); ?></option>
                    </select>
                </div>

                <div class="form-group">
                    <label class="form-label" for = "manuscript_overview_url"><?php echo get_phrase('manuscript_overview_url'); ?></label>
                    <div class="controls">
                        <input type="text" name = "manuscript_overview_url" id = "manuscript_overview_url" class="form-control" value="<?php echo $manuscript_details['video_url'] ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="controls">
                        <input type="text" class="form-control tagsInput" name="meta_keywords" value="<?php echo $manuscript_details['meta_keywords'] ?>">
                    </div>
                </div>

                <div class="form-group">
                    <label for="meta_description"><?php echo get_phrase('meta_description'); ?>:</label>
                    <textarea class="form-control" name = "meta_description" id="meta_description" rows="6"><?php echo $manuscript_details['meta_description'] ?></textarea>
                </div>
            </div>
            <div class="content-update-box">
                <button type="submit" name = "publish" class="btn col-4"><?php echo get_phrase('publish_this_manuscript'); ?></button>
...
function isFreeManuscriptChecked() {

    if (jQuery('#freeManuscriptCheckbox').is(':checked')) {
