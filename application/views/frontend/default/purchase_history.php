                    ...
                    <div class="col">
                        <ul class="purchase-history-list">
                            ...
                            <?php if ($purchase_history->num_rows() > 0):
                                ...
                                $manuscript_details = $this->crud_model->get_manuscript_by_id($each_purchase['manuscript_id'])->row_array();?>
                                    <li class="purchase-history-items mb-2">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="purchase-history-manuscript-img">
                                                    <img src="<?php echo $this->crud_model->get_manuscript_thumbnail_url($each_purchase['manuscript_id']);?>" class="img-fluid">
                                                </div>
                                                <a class="purchase-history-manuscript-title" href="<?php echo site_url('home/manuscript/'.slugify($manuscript_details['title']).'/'.$manuscript_details['id']); ?>" >
                                                    <?php
