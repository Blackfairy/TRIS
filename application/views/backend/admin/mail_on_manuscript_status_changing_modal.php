<form  class="form-horizontal form-groups-bordered" action="<?php echo site_url('admin/change_manuscript_status/'.$param2); ?>" method="post">
  ...
  <input type="hidden" name="researcher_id" value="<?php echo $param5; ?>">
