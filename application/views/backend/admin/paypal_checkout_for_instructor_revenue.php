...
<body>
    ...
    <div class="package-details">
        <strong><?php echo get_phrase('researcher');?> | <?php echo $researcher_name;?></strong> <br>
        <strong><?php echo get_phrase('manuscript_title');?> | <?php echo $manuscript_title;?></strong> <br>
        ...
        onAuthorize: function(data, actions) {
            ...
            return actions.payment.execute().then(function() {
                ...
                $.ajax({
                    ...
                    window.location = '<?php echo site_url('admin/researcher_revenue');?>';
                });
            });
        }
