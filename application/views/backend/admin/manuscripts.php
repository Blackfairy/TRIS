    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <div class="col-xl-3">
                    <div class="form-group">
                        <label for="researcher_id"><?php echo get_phrase('researcher'); ?></label>
                        <select class="form-control select2" data-toggle="select2" name="researcher_id" id = 'researcher_id'>
                            <option value="all" <?php if($selected_researcher_id == 'all') echo 'selected'; ?>><?php echo get_phrase('all'); ?></option>
                            <?php foreach ($researchers as $researcher): ?>
                                <option value="<?php echo $researcher['id']; ?>" <?php if($selected_researcher_id == $researcher['id']) echo 'selected'; ?>><?php echo $researcher['first_name'].' '.$researcher['last_name']; ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <td><?php echo ++$key; ?></td>
                                    <td>
                                        <strong><a href="<?php echo site_url('admin/manuscript_form/manuscript_edit/'.$manuscript['id']); ?>"><?php echo ellipsis($manuscript['title']); ?></a></strong><br>
