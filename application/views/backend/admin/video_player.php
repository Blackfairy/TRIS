<?php
    ...
    $manuscript_details = $this->crud_model->get_manuscript_by_id($lesson_details['manuscript_id'])->row_array();
?>
<ul class="breadcrumb">
    <li><a href="<?php echo site_url('admin/dashboard'); ?>" class=""><?php echo get_phrase('dashboard'); ?></a> </li>
    <li><a href="<?php echo site_url('admin/lessons/').$lesson_details['manuscript_id']; ?>"><?php echo get_phrase('lessons'); ?></a> </li>
        ...
        <div class="col-md-12">
            <div class="grid simple">
                <div class="grid-title no-border">
                    <h4><?php echo get_phrase('manuscript_title'); ?> : <span style="font-weight: 800;"><?php echo $manuscript_details['title']; ?></span></h4>
