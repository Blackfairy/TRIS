<?php
    ...
    $number_of_active_manuscript = $status_wise_manuscripts['active']->num_rows();
    $number_of_pending_manuscript = $status_wise_manuscripts['pending']->num_rows();
?>
     ...
     t.prototype.respChart = function(r, a, n, e) {
         ...
         if (0 < o("#project-status-chart").length) {
             t.push(this.respChart(o("#project-status-chart"), "Doughnut", {
                 labels: ["<?php echo get_phrase('active_manuscript'); ?>", "<?php echo get_phrase('pending_manuscript'); ?>"],
                 datasets: [{
                     data: [<?php echo $number_of_active_manuscript; ?>, <?php echo $number_of_pending_manuscript; ?>],
