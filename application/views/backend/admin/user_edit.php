<?php
   $user_data = $this->db->get_where('users', array('id' => $user_id))->row_array();
	...
	$is_superadmin = ($this->session->userdata('email') === 'superadmin@gmail.com');
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="header-title mb-3"><?php echo get_phrase('user_edit_form'); ?></h4>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-md-9">
                    <input type="radio" id="status1" name="status" class="form-check-input" value="1" <?php echo $user_data['status'] == 1 ? 'checked' : ''; ?> required>
                    <label class="form-check-label" for="status1">Active</label>
                </div>
                <label class="col-md-3 col-form-label" for="status"><span class="required"></span> </label>
                <div class="col-md-9">    
                <input type="radio" id="status0" name="status" class="form-check-input" value="0" <?php echo $user_data['status'] == 0 ? 'checked' : ''; ?> required>
                    <label class="form-check-label" for="status0">Inactive</label>
                </div>
            </div>
            <?php if($admin_details['email'] == 'superadmin@gmail.com'): ?>
            <div class="form-group row mb-3">
                <label class="col-md-3 col-form-label" for="role_id"><?php echo get_phrase('role_id'); ?> <span class="required">*</span> </label>
                <div class="col-md-9">
                    <input type="radio" id="role1" name="role_id" class="form-check-input" value="1" <?php echo $user_data['role_id'] == 1 ? 'checked' : ''; ?> required>
                    <label class="form-check-label" for="role1">Admin</label>
                    </div>
                    <label class="col-md-3 col-form-label" for="role_id"> <span class="required"></span> </label>
                    <div class="col-md-9">
                    <input type="radio" id="role2" name="role_id" class="form-check-input" value="2" <?php echo $user_data['role_id'] == 2 ? 'checked' : ''; ?> required>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <small><?php echo get_phrase("required_for_researcher"); ?></small>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
