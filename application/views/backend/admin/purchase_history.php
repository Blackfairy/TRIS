              ...
              <table class="table" id="example3">
                  <thead>
                    <tr>
                      ...
                      <th><?php echo get_phrase('purchased_manuscript'); ?></th>
                  ...
                  <tbody>
                      <?php foreach ($purchase_history->result_array() as $purchase):
                          ...
                          $manuscript_data = $this->db->get_where('manuscript', array('id' => $purchase['manuscript_id']))->row_array();?>
                          <tr class="gradeU">
                            ...
                            <td><?php echo $manuscript_data['title']; ?></td>
