...
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
              <h4 class="mb-3 header-title"><?php echo get_phrase('accessed_histories'); ?></h4>
                      ...
                      <table class="table table-striped table-centered mb-0">
                          <thead>
                              <tr>
                                  ...
                                  <th><?php echo get_phrase('accessed_date'); ?></th>
                          ...
                          <tbody>
                              <?php foreach ($enrol_history->result_array() as $enrol):
                                  ...
                                  $manuscript_data = $this->db->get_where('manuscript', array('id' => $enrol['manuscript_id']))->row_array();?>
                                  <tr class="gradeU">
                                      <td>
                                      ...
                                      <td><strong><a href="<?php echo site_url('admin/manuscript_form/manuscript_edit/'.$manuscript_data['id']); ?>" target="_blank"><?php echo ellipsis($manuscript_data['title']); ?></a></strong></td>
